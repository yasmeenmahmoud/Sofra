...
public class OurCurrentOrderAdapter extends RecyclerView.Adapter<OurCurrentOrderAdapter.Filesviewholder> {
    ...
    public OurCurrentOrderAdapter(Context context, List<RestaurantOrders_Data> data) {
    ...
    @NonNull
    @Override
    public OurCurrentOrderAdapter.Filesviewholder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        layoutInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view;
        view = layoutInflater.inflate(R.layout.ourcurrentorders_listviewitems, null);
        OurCurrentOrderAdapter.Filesviewholder filesviewholder = new OurCurrentOrderAdapter.Filesviewholder(view);
        return filesviewholder;
    }

    @Override
    public void onBindViewHolder(@NonNull final OurCurrentOrderAdapter.Filesviewholder filesviewholder, int i) {
